...
public class MysqlGenerator {
     ...
     * 包名
     */
    private static final String PACKAGE_NAME = "com.mistray";
    /**
     * 模块名称
     */
    private static final String MODULE_NAME = "MistRay";
    /**
     * 输出文件的路径
     */
    private static final String OUT_PATH = "/Users/zhangjunyi/Documents/workspace/mybatis-plus-customer/src/main/java";
    /**
     * 代码生成者
     */
    private static final String AUTHOR = "MistRay";

    /**
     * JDBC相关配置
     */
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/testone?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
    ...
    public static void main(String[] args) {
        ...
        //修改时，修改时间会修改，
        //虽然像Mysql数据库有自动更机制，但像ORACLE的数据库就没有了，
...
//                                .setTableFillList(tableFillList)
                ...
                // .setControllerMappingHyphenStyle(true)
                        ...
                        new PackageConfig().setModuleName(MODULE_NAME).setParent(PACKAGE_NAME)// 自定义包路径
                                .setController("interfaces")// 这里是控制器包名，默认 web
                                .setXml("mapper").setMapper("persistence")
                                .setEntity("model")
